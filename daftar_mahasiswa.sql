...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Feb 2022 pada 12.52
...
CREATE TABLE `pendaftaran` (
  ...
  `provinsi` char(11) NOT NULL,
  `kabupaten` char(11) NOT NULL,
  `kecamatan` char(11) NOT NULL,
...
INSERT INTO `pendaftaran` (`id_pendaftaran`, `nama`, `nik`, `tempat_lahir`, `tanggal_lahir`, `jns_kelamin`, `kewarganegaraan`, `agama`, `nama_ibu`, `email`, `no_telp`, `alamat`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `pendidikan`, `sekolah`, `nilai_raport`, `prog1`, `prog2`) VALUES
(42, 'Abang', '7371642009910879', 'Bandung', '2022-02-03', 1, 'WNI', 'Islam', 'Santi', 'asa@basuki.com', '089080876769', 'Jl. Melati No. 89', '90876', '13', '1302', '130205', 'SMK-IPA', 'SMK Budi Luhur', 98, 'D3 - Teknik Komputer', 'D3 - Manajemen Informatika'),
(43, 'Rangga Cinta', '7441642009910875', 'Oxford', '2022-02-04', 2, 'WNA', 'Katolik', 'Anisa', 'dinayy@yahoo.com', '087859745635', 'Jl. Bunga Bunga 87', '67589', '36', '3602', '360210', 'SMK-IPA', 'SMK 18 Citra', 87, 'S1 - Sistem Informasi', 'D3 - Teknik Komputer'),
(44, 'Ardiansyah', '7251642009910994', 'Solo', '2022-02-07', 1, 'WNI', 'Budha', 'Putsi Sunkar', 'admin@admin.com', '088878876655', 'Jl. Kereta Kencana', '87769', '51', '5103', '510301', 'SMA-IPS', 'SMA 18 Makassar', 88, 'D3 - Manajemen Informatika', 'S1 - Sistem Informasi');
...
--
ALTER TABLE `pendaftaran`
  MODIFY `id_pendaftaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
COMMIT;
